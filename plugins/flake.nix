...
# "github:NixOS/nixpkgs/nixpkgs-unstable"
{
  inputs = {
    ...
    blink-cmp-avante.url = "github:Kaiser-Yang/blink-cmp-avante/master";
    blink-cmp.flake = false;
    blink-cmp.url = "github:saghen/blink.cmp/main";
    blink-compat.flake = false;
    blink-compat.url = "github:saghen/blink.compat/main";
    blink-copilot.flake = false;
    blink-copilot.url = "github:fang2hou/blink-copilot/main";
    ...
    cmp-conjure.url = "github:PaterJason/cmp-conjure/master";
    cmp-git.flake = false;
    cmp-git.url = "github:petertriho/cmp-git/main";
    cmp-latex-symbols.flake = false;
    cmp-latex-symbols.url = "github:kdheepak/cmp-latex-symbols/main";
    cmp-mini-snippets.flake = false;
    cmp-mini-snippets.url = "github:abeldekat/cmp-mini-snippets/main";
    ...
    cmp-r.flake = false;
    cmp-r.url = "github:R-nvim/cmp-r/main";
    ...
    haskell-tools-nvim.url = "github:mrcjkb/haskell-tools.nvim/main";
    helm-ls-nvim.flake = false;
    helm-ls-nvim.url = "github:qvalentin/helm-ls.nvim/main";
    img-clip-nvim.flake = false;
    img-clip-nvim.url = "github:HakonHarnes/img-clip.nvim/main";
    ...
    neotest-dart.flake = false;
    neotest-dart.url = "github:sidlatau/neotest-dart/main";
    neotest-elixir.flake = false;
    neotest-elixir.url = "github:jfpedroza/neotest-elixir/master";
    neotest-golang.flake = false;
    neotest-golang.url = "github:fredrikaverpil/neotest-golang/main";
    neotest-haskell.flake = false;
    neotest-haskell.url = "github:mrcjkb/neotest-haskell/main";
    neotest-pest.flake = false;
    neotest-pest.url = "github:V13Axel/neotest-pest/main";
    neotest-phpunit.flake = false;
    neotest-phpunit.url = "github:olimorris/neotest-phpunit/main";
    neotest-python.flake = false;
    neotest-python.url = "github:nvim-neotest/neotest-python/master";
    neotest-rspec.flake = false;
    neotest-rspec.url = "github:olimorris/neotest-rspec/main";
    neotest-testthat.flake = false;
    neotest-testthat.url = "github:shunsambongi/neotest-testthat/main";
    neotest-vstest.flake = false;
    neotest-vstest.url = "github:Nsidorenco/neotest-vstest/main";
    neotest-zig.flake = false;
    neotest-zig.url = "github:lawrence-laz/neotest-zig/main";
    neotest.flake = false;
    ...
    nvim-dap-go.flake = false;
    nvim-dap-go.url = "github:leoluz/nvim-dap-go/main";
    nvim-dap-python.flake = false;
    nvim-dap-python.url = "github:mfussenegger/nvim-dap-python/master";
    nvim-dap-ruby.flake = false;
    nvim-dap-ruby.url = "github:suketa/nvim-dap-ruby/main";
    ...
    telescope-terraform-doc-nvim.flake = false;
    telescope-terraform-doc-nvim.url = "github:ANGkeith/telescope-terraform-doc.nvim/main";
    telescope-terraform-nvim.flake = false;
    telescope-terraform-nvim.url = "github:cappyzawa/telescope-terraform.nvim/main";
